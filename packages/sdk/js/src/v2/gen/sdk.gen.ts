...
import type {
  ...
  GlobalLoginErrors,
  GlobalLoginResponses,
  GlobalLogoutErrors,
  GlobalLogoutResponses,
  GlobalUpgradeErrors,
...
export class Global extends HeyApiClient {
   ...
   * Login
   *
   * Authenticate with username and password, then get bearer token.
   */
  public login<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<GlobalLoginResponses, GlobalLoginErrors, ThrowOnError>({
      url: "/global/login",
      ...options,
      ...params,
      headers: {
   ...
   * Logout
   *
   * Revoke bearer token from current session.
   */
  public logout<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>) {
    return (options?.client ?? this.client).post<GlobalLogoutResponses, GlobalLogoutErrors, ThrowOnError>({
      url: "/global/logout",
      ...options,
    })
  }
