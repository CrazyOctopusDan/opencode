...
export const Flag = {
  ...
  OPENCODE_AUTH_TOKEN_TTL_SECONDS: process.env["OPENCODE_AUTH_TOKEN_TTL_SECONDS"],
  OPENCODE_LOCKED_MODEL_POLICY: process.env["OPENCODE_LOCKED_MODEL_POLICY"],
  OPENCODE_LOCKED_MODEL_POLICY_URL: process.env["OPENCODE_LOCKED_MODEL_POLICY_URL"],
  OPENCODE_LOCKED_MODEL_POLICY_TOKEN: process.env["OPENCODE_LOCKED_MODEL_POLICY_TOKEN"],
  OPENCODE_LOCKED_MODEL_POLICY_REFRESH_SECONDS: number("OPENCODE_LOCKED_MODEL_POLICY_REFRESH_SECONDS"),
  OPENCODE_TEMPO_BASE_URL: process.env["OPENCODE_TEMPO_BASE_URL"],
  OPENCODE_TEMPO_ENV: process.env["OPENCODE_TEMPO_ENV"],
  OPENCODE_TEMPO_DEV_BASE_URL: process.env["OPENCODE_TEMPO_DEV_BASE_URL"],
  OPENCODE_TEMPO_PROD_BASE_URL: process.env["OPENCODE_TEMPO_PROD_BASE_URL"],
  OPENCODE_TEMPO_SM2_PUBLIC_KEY: process.env["OPENCODE_TEMPO_SM2_PUBLIC_KEY"],
