...
import { createApiForServer, createAuthRecoveringFetch, createSdkForServer, type ServerApi } from "@/utils/server"
...
function createServerSdkContextBase(server: ServerConnection.Any, scope: ServerScope): ServerSDKBase {
  ...
  const eventApi = createApiForServer({ server: server.http, fetch: eventFetchWithAuthRecovery })
  ...
  const currentApi: ServerApi = createApiForServer({ server: server.http, fetch: fetchWithAuthRecovery })
