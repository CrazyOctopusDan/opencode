...
function makeQueryOptionsApi(
  ...
  recoverProviderAuth: (directory: PathKey | null) => Promise<OpencodeClient | undefined>,
) {
  return {
...
export function createServerSyncContextInner(serverSDK: ServerSDK) {
  ...
  const queryOptionsApi = makeQueryOptionsApi(serverSDK.scope, () => serverSDK.client, sdkFor, recoverProviderAuth)
